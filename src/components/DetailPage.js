...
export function DetailPage() {
  ...
  return (
    <Suspense fallback={<Loader />}>
      ...
      <NavBar />
      <div className="font-cera container mx-auto p-8 pt-32 flex flex-col lg:grid grid-all gap-4">
        <div className="flex flex-col justify-center grow gap-4 p-8 md:p-12 bg-sucor-500 rounded-md text-white outline outline-0 grid-profile">
          <div>
